    ...
    <div class="bg-dark-green-80">
        <div class="flex flex-col justify-self-center min-w-[320px] w-5xl max-w-5xl min-h-screen p-5">
            <div class="flex flex-row w-full justify-end">
                <flux:button variant="ghost" size="sm" wire:click="loginRedirect">Log In</flux:button>
                <flux:button variant="primary" size="sm" wire:click="signupRedirect">Sign Up</flux:button>
            </div>
            ...
            <div>
                ...
                <flux:button class="mt-[3%]">Join Now</flux:button>
            </div>
        </div>
    </div>
</body>
